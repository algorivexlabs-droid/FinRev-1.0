...
import { TrendingUp, Coins, Target, Flag, AlertTriangle } from 'lucide-react';
...
export function FinancialGoalCalculator() {
  ...
  const validate = (values: GoalInput): Partial<Record<keyof GoalInput, string>> => {
    ...
    if (!values.goalAmount || values.goalAmount < 10000) {
      errs.goalAmount = 'Goal amount must be at least ₹10,000';
    }
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-lg text-neutral-600 dark:text-neutral-400">
          Plan for any financial goal with systematic investing
        </p>
      </div>
      ...
      {result && (
        <>
          ...
          <ChartPlaceholder
            title="Goal Fund Growth Projection"
            description="Chart visualization would show corpus growth towards your financial goal"
          />
